...
<body>
    ...
    if($method == "POST"){
        ...
        if($showAlert){
            ...
            <strong>Success!</strong> Your Problem has been added Please Wait for Community to Response.
...
<h2 class="py-2">Start Discussions.</h2>
    <!-- /forums/threadlist.php?catid='.$id.' -->
    <form action="'.$_SERVER['REQUEST_URI']. '"method="post">
        <div class="form-group">
            <label for="exampleInputEmail1">Problem Title</label>
            <input type="text" class="form-control" id="title" name="title" aria-describedby="emailHelp">
            <small id="emailHelp" class="form-text text-muted">Write Problem title in Short.</small>
        </div>
